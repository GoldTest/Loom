...
const zhDict: Dictionary = {
  ...
  'db.tool.customArgsPlaceholder': '输入工具级别的默认执行参数 (例如 --model gemini-1.5-pro)',
  ...
  'cat.toast.smartClassified': '智能分类完成：{sys} 个系统工具，{dev} 个开发工具',
  ...
  'env.editor.subtitle': '在这里定义所有的全局环境变量。保存后可在设置指令模板时进行勾选和自由组合。',
  ...
  'libs.docs.title': '全局指令文档',
  'libs.btn.newDoc': '新建文档',
  'libs.empty.skills': '暂无全局技能模版',
  'libs.empty.docs': '暂无全局指令文档模版',
  ...
  'libs.toast.skillMdCoreWarn': '主说明文件名 SKILL.md 为固定核心，请直接在主内容区编写。',
  ...
  'libs.modal.editDoc': '编辑全局指令文档',
  'libs.modal.newDoc': '新建全局指令文档',
  ...
  'libs.toast.updateDocSuccess': '更新全局指令文档成功',
  'libs.toast.createDocSuccess': '新建全局指令文档成功',
  ...
  'proj.empty.desc': '关联您的本地开发项目，即可开始集中监管项目下的 CLI Agent。',
  ...
  'proj.confirm.delete': '确定要取消与项目 "{name}" 的关联吗？所有在该项目下运行的历史记录都将被清除。',
  ...
  'proj.launcher.noTemplates': '暂无运行模板。请前往“设置”为您的 CLI 工具创建运行模板。',
...
const enDict: Dictionary = {
  ...
  'db.tool.customArgsPlaceholder': 'Enter tool-level default arguments (e.g. --model gemini-1.5-pro)',
  ...
  'cat.toast.smartClassified': 'Smart classify done: {sys} system tools, {dev} dev tools',
  ...
  'env.desc': 'Define environment variables that can be shared and freely combined across multiple run templates.',
  'env.search.placeholder': 'Search env variables…',
  'env.editor.title': 'Configure Variables',
  'env.editor.subtitle': 'Define global environment variables here. Once saved, you can check and combine them in any command template.',
  'env.table.key': 'Key',
  ...
  'temp.modal.globalEnvsDesc': 'Check the global environment variables that should apply to this template:',
  'temp.modal.noGlobalEnvs': 'No global environment variables found. Go to the Env page to create some first.',
  ...
  'settings.system.autostartDesc': 'Automatically run Loom when the system starts',
  ...
  'settings.theme.desc': 'Select between Dark or Day themes.',
  ...
  'settings.font.desc': 'Select font family and size. Changes apply immediately and persist.',
  ...
  'libs.confirm.deleteSkill': 'Are you sure you want to delete skill template "{name}"?',
  'libs.confirm.deleteDoc': 'Are you sure you want to delete document template "{name}"?',
  ...
  'libs.modal.skillDescPlaceholder': 'Short description of this skill folder\'s purpose',
  ...
  'libs.toast.skillMdCoreWarn': 'The main instruction file SKILL.md is fixed. Please edit it in the main content area.',
  'libs.toast.fileExist': 'This sub-file already exists',
  'libs.confirm.deleteSubFile': 'Are you sure you want to delete this sub-file?',
  'libs.toast.updateSkillSuccess': 'Successfully updated global skill and sub-files',
  'libs.toast.createSkillSuccess': 'Successfully created global skill and sub-files',
  ...
  'proj.empty.desc': 'Associate local development directories to manage and supervise CLI agents under them.',
  ...
  'proj.confirm.delete': 'Are you sure you want to unregister project "{name}"? All local run history will be removed.',
  'proj.launcher.title': 'Spawn New Agent (Quick Spawn)',
  'proj.launcher.cmdPlaceholder': 'Enter command (e.g. agy, npm, git)...',
  'proj.launcher.argsPlaceholder': 'Enter arguments (e.g. --task "refactor auth")...',
  ...
  'proj.launcher.noTemplates': 'No templates available. Go to settings to create templates for your CLI tools.',
